...
I don't want to get into too many details here but R has some very useful functions for dealing with/cleaning strings. I will be writing another post on this in the coming weeks.

## String Padding

Consider an example that will become relevant in coming lessons. We have a vector of numbers which currently runs 1-19. Now what if we need all the 'single character' digits to have a leading one. That is instead of "1" we need "01". 
