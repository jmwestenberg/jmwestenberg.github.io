...
filename<-paste0(workingdir, file.path("processed_data", "county_data_all.rda"))
save(county_data, file=filename)
```
...
- Lines #11-#16: See [Downloading/Reading Data](http://jmwestenberg.github.io/courses/rcourse/lesson1_04/) for a direct explanation.
